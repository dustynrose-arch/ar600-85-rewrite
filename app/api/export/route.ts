...
export async function GET(request: Request) {
  ...
  const filename = summary
    ...
    : trackChanges
      ? training
        ? "AR600-85-Rewrite-TRAINING-TRACK-CHANGES-DRAFT.docx"
        : "AR600-85-Rewrite-TRACK-CHANGES-DRAFT.docx"
      : training
  ...
  return new NextResponse(Uint8Array.from(buffer), {
    headers: {
      ...
      "X-Export-Kind": summary ? "summary-of-change" : trackChanges ? "track-changes" : "working-copy",
    },
  });
}
