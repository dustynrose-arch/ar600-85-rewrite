...
**Not an official publication.** Word exports (header, footer, and title page) are always marked **DRAFT / WORKING COPY**. The on-screen workspace has no DRAFT banner or chip.
