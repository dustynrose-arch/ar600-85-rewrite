...
| Guide | Header **User Guide** opens a panel over the draft workbench (Close or Escape). `/guide` only returns you to that same panel. Assist help is written for G–1 editors. |
