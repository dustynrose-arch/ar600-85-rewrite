...
| Guide | Header **User Guide** opens a panel over the draft workbench (Close or Escape): the text guide plus the First-session contents. `/guide` only returns you to that same panel. Assist help is written for G–1 editors. |
